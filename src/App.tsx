...
function ImportUI({ collection }: { collection: Collection }) {
    ...
    return (
        <form ref={form} className="import-collection" onSubmit={handleSubmit}>
            ...
            {isDragging && <div className="dropzone dragging">{isDragging && <p>Drop JSON file to import</p>}</div>}
                ...
                <>
                    <div className="intro">
                        ...
                        <div className="content">
                            <h2>Upload JSON</h2>
                            <p>
                                Make sure your collection fields in Framer match the names of the keys in your JSON
                                file.
                            </p>
                        </div>
                    </div>
